...
namespace EmployeeDBApplication.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Department,Name,Rate")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Department,Name,Rate")] Department department)
        {
            if (ModelState.IsValid)
            {
