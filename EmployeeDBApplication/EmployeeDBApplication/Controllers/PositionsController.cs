...
namespace EmployeeDBApplication.Controllers
{
    public class PositionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Position,Name,Rate")] Position position)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Position,Name,Rate")] Position position)
        {
            if (ModelState.IsValid)
            {
